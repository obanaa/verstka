...
//  What's new Block
    ...
    public function headerLinks()
    {
        ...
        $I->waitForElementVisible(self::$devOpsHeader);
        $I->click(self::$devOpsHeader);
        $I->waitForElement(self::$h3);
        $I->see('DevOps',self::$h3);
        $I->moveMouseOver(self::$ourServicesHeader);
        $I->waitForElementVisible(self::$webDevHeader);
        $I->click(self::$webDevHeader);
        $I->waitForElement(self::$h3);
        $I->see('Web Development',self::$h3);
        $I->moveMouseOver(self::$ourServicesHeader);
        $I->waitForElementVisible(self::$designHeader);
        $I->click(self::$designHeader);
        $I->waitForElement(self::$h3);
        $I->see('Design',self::$h3);
        $I->moveMouseOver(self::$ourServicesHeader);
        $I->waitForElementVisible(self::$bigDataHeader);
        $I->click(self::$bigDataHeader);
        $I->waitForElement(self::$h3);
